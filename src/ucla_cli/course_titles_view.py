...
def course_titles_view(term, subject, subject_name, page):
    cookies = {
            ...
            json.dumps(
                {
                    ...
                    "crs_catlg_no": None,
                    # "subj_area_cd": "MATH   ",
                    "subj_area_cd": subject, #search_data["subj_area_cd"],
                    # "subj_area_name": "Mathematics (MATH)",
                    "subj_area_name": subject_name, #search_data["SubjectAreaName"],
                    "class_prim_act_fl": "y",
                },
                separators=(",", ":"),
            )
